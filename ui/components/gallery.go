...
func Gallery() []Example {
	...
	return []Example{
		...
		e("Form", "Input / file", Input(InputProps{Name: "cover", Type: "file", Label: "Cover image",
			Accept: "image/png,image/jpeg", HelpText: "PNG or JPEG. The form it sits in is multipart."})),
		e("Form", "Input / file multiple", Input(InputProps{Name: "attachments", Type: "file",
			Label: "Attachments", Accept: "image/*", Multiple: true})),
