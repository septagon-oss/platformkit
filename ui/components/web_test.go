...
// web_test.go checks each renderer's own contract: the markup, the ARIA
// structure and the class lists it composes. The gallery-wide closure — every
// rendered class declared and resolvable, no inline handlers — renders Gallery
// and therefore lives in ui/components/examples/closure_test.go.
