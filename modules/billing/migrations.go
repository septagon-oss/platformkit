...
// Migrations is this module's SQL as one source — plans, subscriptions and their billing anchor — owned as
// "billing". The manifest hands the kernel the same files and adoption, and a test
// composes the schema it needs beside the foundation: dbtest.Schema(t, billing.Migrations).
//
...
var Migrations = db.MigrationSource{
	...
	Adopts: []db.Adoption{{Owner: "platformkit", Versions: []int64{16, 22}}},
}
