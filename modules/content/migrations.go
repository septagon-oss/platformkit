...
// Migrations is this module's SQL as one source — the contents table — owned as
// "content". The manifest hands the kernel the same files and adoption, and a test
// composes the schema it needs beside the foundation: dbtest.Schema(t, content.Migrations).
//
...
var Migrations = db.MigrationSource{
	...
	Adopts: []db.Adoption{{Owner: "platformkit", Versions: []int64{17}}},
}
