...
// Migrations is this module's SQL as one source — the tasks table and its indexes — owned as
// "task". The manifest hands the kernel the same files and adoption, and a test
// composes the schema it needs beside the foundation: dbtest.Schema(t, task.Migrations).
//
...
var Migrations = db.MigrationSource{
	...
	Adopts: []db.Adoption{{Owner: "platformkit", Versions: []int64{4}}},
}
