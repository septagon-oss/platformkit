...
// answer. spec.Immutable is the other half of that argument, and crud.Command
// is the part all three share.
func RegisterRoutes(api *httpx.API, spec crud.Spec[*contracts.User], svc contracts.Service) {
	crud.Command(api, spec, "set-password",
	...
	crud.Command(api, spec, "deactivate",
		"Deactivate a user",
