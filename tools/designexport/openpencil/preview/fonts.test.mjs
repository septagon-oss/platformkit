...
import ("encoding/json"; "os"; "github.com/septagon-oss/platformkit/design"; "github.com/septagon-oss/platformkit/ui/export"; "github.com/septagon-oss/platformkit/ui/components/examples")
func main() {
  snapshot, err := export.Export(design.Default(), examples.Gallery())
